<?php
    ...
    class InjectableTest extends UnitTestCase {
        public function testDiNotSet() {
            /** @var \TwistersFury\Phalcon\Core\Traits\Injectable|\PHPUnit_Framework_MockObject_MockObject $mockInjectable */
            $mockInjectable = $this->getMockBuilder('\TwistersFury\Phalcon\Core\Traits\Injectable')
                ->getMockForTrait();
